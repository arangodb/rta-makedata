...
(function () {
  return {
    ...
    makeDataDB: function (options, isCluster, isEnterprise, database, dbCount) {
      ...
      // Perform 'update' operation for collection c3
      let c3_count_before = Number(db._query(`for doc in ${collections_names[3]} filter has(doc, 'cv_field_update') == true collect with count into c return c`).toArray());
