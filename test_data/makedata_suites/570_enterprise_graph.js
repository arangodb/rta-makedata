...
(function () {
  ...
  return {
    ...
    makeDataDB: function (options, isCluster, isEnterprise, database, dbCount) {
      ...
      progress(`570: making per database data ${dbCount}`);
    ...
    checkDataDB: function (options, isCluster, isEnterprise, database, dbCount, readOnly) {
      progress(`570: checking data in database ${database} dbCount: ${dbCount}`);
      let baseName = database;
      if (baseName === "_system") {
        baseName = "system";
      }
    ...
    clearDataDB: function (options, isCluster, isEnterprise, database, dbCount) {
      progress(`570: Clearing data. Database: ${database}. DBCount: ${dbCount}`);
      let baseName = database;
      if (baseName === "_system") {
        baseName = "system";
      }
